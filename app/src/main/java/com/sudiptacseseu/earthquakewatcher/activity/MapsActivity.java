package com.sudiptacseseu.earthquakewatcher.activity;
...
import com.sudiptacseseu.earthquakewatcher.model.EarthQuake;
import com.sudiptacseseu.earthquakewatcher.ui.CustomInfoWindow;
import com.sudiptacseseu.earthquakewatcher.R;
import com.sudiptacseseu.earthquakewatcher.util.Constants;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    private FloatingActionButton viewAllFab;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewAllFab = findViewById(R.id.viewAllFabId);
        viewAllFab.setOnClickListener(new View.OnClickListener() {
            @Override
